...
const CATEGORY_RULES: CategoryRule[] = [
	{
		category: "constraint",
		keywords: ["cannot", "must not", "must-not", "limit", "restriction", "forbidden", "prohibited", "disallowed", "not allowed"],
		weight: 1.0,
	},
	{
		category: "decision",
		keywords: ["decided", "chose", "chosen", "reason", "because", "trade-off", "tradeoff", "rationale", "opted", "selected"],
		weight: 0.9,
	},
	{
		category: "bug_pattern",
		keywords: ["bug", "error", "issue", "crash", "null", "undefined", "race condition", "deadlock", "memory leak", "exception", "throws", "fails", "broken"],
		weight: 0.9,
	},
	{
		category: "preference",
		keywords: ["prefer", "should", "always", "never", "convention", "recommended", "best practice", "avoid", "favor", "instead of", "use X over"],
		weight: 0.85,
	},
	{
		category: "skill",
		keywords: ["pattern", "approach", "technique", "strategy", "how to", "method", "algorithm", "recipe", "template"],
		weight: 0.8,
	},
	{
		category: "relationship",
		keywords: ["depends on", "calls", "uses", "inherits", "extends", "implements", "imports", "requires", "connected to", "linked to", "belongs to"],
		weight: 0.8,
	},
	{
		category: "fact",
		keywords: ["uses", "is", "returns", "stores", "contains", "has", "provides", "exposes", "exports"],
		weight: 0.5,
	},
];
