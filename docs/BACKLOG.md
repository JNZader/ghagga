...
**Status: RESOLVED** 2026-09-26. Live write against gitlab.com
`JNZader/ghagga-runner-template` MR `!1`: create note + update-in-place
(FORGE-UPSERT-005). The manual test had still asserted delete-then-repost;
aligned in PR #429. Fine-grained PAT needs **Work Item: Create** (GitLab 19.5
MR notes are work items).
